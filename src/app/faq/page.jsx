...
const FAQ_GROUPS = [
  {
    ...
    items: [
      {
        q: '잇다는 어떤 서비스인가요?',
        a: '잇다는 가족이 돌아가신 후 처리해야 할 행정·금융·디지털 절차를 한 곳에서 안내하는 무료 플랫폼입니다. 정부기관, 은행, 통신사, SNS, 보험 등 35개 이상의 기관에 대한 절차를 정리하고 공식 신청 페이지로 직접 연결해드립니다.',
      },
      {
        q: '비용이 드나요?',
        a: '절차 안내, 체크리스트, 가이드는 모두 무료입니다. 비용은 전문가(법무사·변호사) 직접 연결을 요청하실 때만 발생합니다.',
      },
      {
        q: '회원가입이 필요한가요?',
